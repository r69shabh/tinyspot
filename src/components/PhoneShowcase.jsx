          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center justify-center">
            ...
            <div className="lg:col-span-5 flex flex-col items-center">
              <div className="mb-2 text-center">
                ...
                <p className="text-[11px] text-ink-2">Prime cover tier ($5 minimum) · Maximum daily glanceability</p>
              </div>
              <OutsideScreen
                spots={spots}
                mode={mode}
            ...
            <div className="lg:col-span-7 flex flex-col items-center">
              <div className="mb-2 text-center">
                ...
                <p className="text-[11px] text-ink-2">15 spots ($1 minimum) across dual folding canvas</p>
              </div>
              <InsideScreen
                spots={spots}
                mode={mode}
